...
function processTest(args) {
   ...
   //const thingName = 'weatherstaton';
   const thingName = 'myIOT';
   //const nonThingName = 'nonThingTopic1';
   const nonThingName = 'nonThingTopic2';
...
//#D readout contains two values: temperature and humidity
   ...
   function handleDelta(thingName, stateObject) {
      if (args.testMode === 2) {
       ...
       //     }));
         thingShadows.publish(nonThingName, JSON.stringify(stateObject.state.value)); 
            console.log('published to ' + nonThingName + JSON.stringify(stateObject.state.value));
      }
   }
